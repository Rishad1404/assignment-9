    ...
    return (
        <div className="container mx-auto mb-20">
            ...
            <div className=" max-w-md p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800 md:w-3/4 lg:w-1/2 mx-auto">
                ...
                <p className="text-sm text-center sm:px-6 dark:text-gray-600">Do not have an account?
                    <Link to='/register' className="underline text-orange-500 font-semibold">Register</Link>
                </p>
            </div>
